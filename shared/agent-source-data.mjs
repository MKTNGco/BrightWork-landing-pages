/**
 * Canonical office + program facts for WebMCP tools, agents.json, and llms.txt.
...
export const SHARED_TOOL_LIMITATIONS = [
...
export const OFFMARKET_PROGRAM = {
  name: 'Off-Market Access',
  url: 'https://offmarket.brightworkrealty.com/',
  tagline: 'The Smart Way to Real Estate',
...
export const BUYBEFORE_PROGRAM = {
  name: 'Buy Before You Sell',
  url: 'https://buybefore.brightworkrealty.com/',
  tagline: 'The Smart Way to Real Estate',
...
export const BRIGHTFLIP_PROGRAM = {
  name: 'BrightFlip',
  url: 'https://brightflip.brightworkrealty.com/',
  tagline: 'The Smart Way to Real Estate',
...
export const FINALOFFER_PROGRAM = {
  name: 'Final Offer',
  url: 'https://finaloffer.brightworkrealty.com/',
  tagline: 'The Smart Way to Real Estate',
...
export const PROGRAMS_BY_SLUG = {
  offmarket: OFFMARKET_PROGRAM,
  buybefore: BUYBEFORE_PROGRAM,
  seniors: SENIORS_PROGRAM,
  quiet: QUIET_PROGRAM,
  relaunch: RELAUNCH_PROGRAM,
  brightflip: BRIGHTFLIP_PROGRAM,
  finaloffer: FINALOFFER_PROGRAM,
  invest: INVEST_PROGRAM
};

/** Worker page folders included in the agent discoverability upgrade. */
export const PAGE_FOLDERS = [
  { slug: 'offmarket', folder: 'offmarket', subdomain: 'offmarket' },
  { slug: 'buybefore', folder: 'buybefore', subdomain: 'buybefore' },
  { slug: 'seniors', folder: 'seniors', subdomain: 'seniors' },
  { slug: 'quiet', folder: 'quiet', subdomain: 'quiet' },
  { slug: 'relaunch', folder: 'relaunch', subdomain: 'relaunch' },
  { slug: 'brightflip', folder: 'brightflip', subdomain: 'brightflip' },
  { slug: 'finaloffer', folder: 'finaloffer', subdomain: 'finaloffer' },
  { slug: 'invest', folder: 'invest', subdomain: 'invest' }
];
