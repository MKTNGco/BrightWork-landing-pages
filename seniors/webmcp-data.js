...
(function (global) {
  ...
  "PROGRAMS_BY_SLUG": {
    "offmarket": {
      ...
      "benefits": [
        {
          "title": "Privacy-First Sellers",
          "detail": "Homeowners who want a quiet sale without open houses or public exposure."
        },
        {
          "title": "Zero Competition",
          "detail": "Fewer buyers means less pressure. Negotiate on your terms without a bidding frenzy."
        },
        {
          "title": "Pre-Market Head Start",
          "detail": "Many listings are available before sellers commit to a full public launch."
        },
        {
          "title": "Instant Text Notification",
          "detail": "You get a text the moment a new property comes to BrightWork."
        }
      ],
      "serviceArea": [
        "Moraga",
      ...
      "tiers": [
        {
          ...
          "detail": "Paint, floors, lighting, fixtures, curb appeal, and targeted kitchen or bath updates."
        },
        {
          "name": "Partial Remodel",
          "detail": "Kitchen refreshes, bathroom remodels, and significant exterior work when net value justifies scope."
        },
        {
          "name": "Major Renovation and Partnered Projects",
          "detail": "Select larger projects such as ADU work, underwritten carefully. Not every home qualifies."
        }
      ],
      "serviceArea": [
        "Moraga",
    ...
    "invest": {
      ...
      "pillars": [
        {
          "name": "Tax structure",
          "detail": "Conceptual overview of depreciation, deductible expenses, and mortgage interest. Consult your tax advisor for specifics."
        },
        {
          "name": "Long-term wealth",
          "detail": "Combination of equity build, appreciation, depreciation benefits, and eventual rental income over a multi-year horizon."
        },
        {
          "name": "Family housing flexibility",
          "detail": "A local rental can house adult children or aging parents, not just generate returns."
        },
        {
          "name": "Generational strategy",
          "detail": "Some families aim for one investment property per child when finances support it."
        }
      ],
